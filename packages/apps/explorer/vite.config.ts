...
import { PROFILE_DEFAULTS } from '../../shared/src/profile-defaults'
...
const STACK_ENV_FALLBACKS: Record<string, string[]> = {
  ...
  VITE_POWERSYNC_DAEMON_URL: ['POWERGIT_DAEMON_URL', 'POWERSYNC_DAEMON_URL', 'POWERGIT_TEST_DAEMON_URL'],
  VITE_POWERSYNC_USE_DAEMON: ['POWERSYNC_USE_DAEMON'],
  POWERSYNC_DAEMON_DEVICE_URL: ['POWERGIT_DAEMON_DEVICE_URL', 'POWERSYNC_DAEMON_DEVICE_URL'],
}
